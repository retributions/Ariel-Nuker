...
class Ariel:
 ...
 def DChanFunction(guild, channel):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"[{colors.main}-{colors.reset}] {colors.main}Deleted Channel{colors.reset} {channel.strip()}")
                    break
                else:
                    break
 ...
 def BanFunction(guild, member):
   while True:
     ...
     if 'retry_after' in r.text:
        ...
        if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
           print(f"[{colors.main}-{colors.reset}] {colors.main}Bye Bye {colors.reset}{member.strip()}")
           break
        else:
          break
